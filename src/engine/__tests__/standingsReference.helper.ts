// Reference oracle for the scale regression test: the pre-optimization
// per-player-scan implementation of calculateStandings, kept verbatim (only
// renamed). If standings semantics ever change intentionally, update this
// oracle together with the engine.
...
export function calculateStandingsOld(players: Player[], rounds: Round[], game?: GameType, playerFilter?: Set<string>): Standing[] {
