...
export type TournamentAction =
  ...
  | { type: 'DROP_PLAYER'; payload: { tournamentId: string; playerId: string; droppedBy?: string } }
  ...
  | { type: 'START_DECK_CHECK'; payload: { tournamentId: string; matchId: string; startedBy?: string } }
